...
class clase_cliente(models.Model):
    ...
    selection_tracking = ['company_type', 'lang']
    ...
    unidad_medida = fields.Selection(tracking=True, selection=[('Metros Cubicos', 'M3'),('Litros', 'Lts'),('Kilogramos', 'Kg')])
    banco = fields.Selection(tracking=True, selection=[('Bbva', 'BBVA BANCOMER'), ('Santander', 'SANTANDER'), ('Banamex', 'BANAMEX'), ('Banorte', 'BANORTE')])
    regimen = fields.Selection(tracking=True, selection=[('alta_presion', 'Alta presion'),('baja_presion', 'Baja presion')])
    # -------------------------------------------------------------------------
